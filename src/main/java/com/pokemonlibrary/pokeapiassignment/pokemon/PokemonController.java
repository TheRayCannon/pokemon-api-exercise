...
import com.pokemonlibrary.pokeapiassignment.exception.ResourceNotFoundException;
...
public class PokemonController {
    ...
    private Map<String, Iterable<Pokemon>> createHashPlural(Iterable<Pokemon> pokemon) {
